...
class QuickTestScreen extends StatelessWidget {
              ...
              child: SingleChildScrollView(
                ...
                child: Column(children: [
                  ...
                  Text(
                    '삼칠이 작명소'.tr(),
                    style:
                        textTheme.titleLarge!.colored(const Color(0xFF171717)),
                  ),
                  SizedBox(height: 18.h),
                  RichText(
                    text: TextSpan(children: [
                      ...
                      buildSpacing(width: 4.sp),
                      TextSpan(
                        text: '별명 짓기'.tr(),
                        style: textTheme.bodyMedium,
                      ),
                      buildSpacing(width: 1.sp),
  ...
  WidgetSpan buildSpacing({double? width}) {
