...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/img_frame_black_900.svg
  SvgGenImage get imgFrameBlack900 =>
      const SvgGenImage('assets/svg/img_frame_black_900.svg');

  /// File path: assets/svg/img_frame_black_900_32x32.svg
  SvgGenImage get imgFrameBlack90032x32 =>
      const SvgGenImage('assets/svg/img_frame_black_900_32x32.svg');

  /// File path: assets/svg/img_frame_gray_900_02.svg
  SvgGenImage get imgFrameGray90002 =>
      const SvgGenImage('assets/svg/img_frame_gray_900_02.svg');

  /// File path: assets/svg/img_group.svg
  SvgGenImage get imgGroup => const SvgGenImage('assets/svg/img_group.svg');

  /// File path: assets/svg/img_settings.svg
  ...
  /// File path: assets/svg/img_vector_gray_900_04_91x86.svg
  SvgGenImage get imgVectorGray9000491x86 =>
      const SvgGenImage('assets/svg/img_vector_gray_900_04_91x86.svg');

  /// File path: assets/svg/img_vector_white_a700_7x8.svg
  SvgGenImage get imgVectorWhiteA7007x8 =>
      const SvgGenImage('assets/svg/img_vector_white_a700_7x8.svg');

  /// File path: assets/svg/page_not_found.svg
